#Это модуль, который выводит информацию в консоль и меню
# тут выводим на экран из файла db.json. Перебираем этот список
...
@log #@ передает в нашу Ф log, где эта Ф приобразовывается и возвращается обратно
def greatings():
    '''Вывод приветствия.'''
...
@log
def print_book(data: list):  # Ф вывода на экран. НА вход получаем список справочника
    """
