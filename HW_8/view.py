...
def print_data(data: list):
    ...
    """
    print(tabulate(data, headers=var.field, tablefmt="grid")) # tabulate отдельная библиотека, выводится в таблицу headers - заголовок, который хранится в файле var
def print_error():
    """Сообщение об ошибки"""
